...
#
#  Train an actor critic network (reinforcement learning) with DDPG 
...
rp = { 'fpd_scale' : 0.90, 'dx_penalty' : 0.1 }
...
print('loading class of models:', fstring+'*')

#actor_model.load_weights(f'{fstring}actor.h5')
#critic_model.load_weights(f'{fstring}critic.h5')

#target_actor.load_weights(f'{fstring}target_actor.h5')
#target_critic.load_weights(f'{fstring}target_critic.h5')


actor_model = tf.keras.models.load_model(f'{fstring}actor.h5')
critic_model = tf.keras.models.load_model(f'{fstring}critic.h5')
target_actor = tf.keras.models.load_model(f'{fstring}target_actor.h5')
target_critic = tf.keras.models.load_model(f'{fstring}target_critic.h5')
print('loaded!')
